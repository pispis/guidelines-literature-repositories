# -*- coding: utf-8 -*-
#
# OpenAIRE Guidelines documentation build configuration file, created by
# sphinx-quickstart on Wed Jan 21 12:32:46 2015.
#
...
exclude_patterns = ['_build', 'common', 'data/examples']
